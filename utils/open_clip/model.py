...
class CLIPVisionCfg:
    ...
    input_patchnorm: bool = (
        False  # whether to use dual patchnorm - would only apply the input layernorm on each patch, as post-layernorm already exist in original clip vit design
    )
    ...
    attentional_pool: bool = (
        False  # whether to use attentional pooler in the last embedding layer
    )
